...
export async function POST(request: NextRequest) {
  try {
    ...
    if (body.mode === "suggest") {
      ...
      const parsed = extractJson(text) as { summary: string; suggestions: unknown[] }
      return NextResponse.json({ type: "suggestions", summary: parsed.summary, suggestions: parsed.suggestions })
    }
